...
public class Serie{
	...
	public static Serie[] ordenarSeries(Serie[] series){
        for (int i = 1; i < tam1; i++) {
            ...
            int j = i - 1;
            numComparacoes++;
            while ((j >= 0) && (series[j].getIdiomaOriginal().compareTo(tmp.getIdiomaOriginal()) > 0)) {
                series[j + 1] = series[j];
                numMovimentacoes++;
                j--;
                numComparacoes++;
            ...
            numComparacoes += 2;	
            while((j >= 0) && (series[j].getIdiomaOriginal().compareTo(tmp.getIdiomaOriginal()) == 0) && (series[j].getNome().compareTo(tmp.getNome()) > 0)){
                numComparacoes++;
                series[j + 1] = series[j];
                j--;
            }
	...
	public static void main(String[] args)throws ParseException{
		...
		Arq.openWrite("716274_insercao.txt");
